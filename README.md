...
- **[API Reference](./API.md)** — REST endpoints and WebSocket feeds
- **[Contract Addresses](./CONTRACTS.md)** — Deployed contracts on mainnet and testnet

## Networks

| Network | Chain ID | RPC | Explorer |
|---------|----------|-----|----------|
| Mainnet | `1440000` | `https://rpc.xrplevm.org` | [explorer.xrplevm.org](https://explorer.xrplevm.org) |
| Testnet | `1449000` | `https://rpc.testnet.xrplevm.org` | [explorer.testnet.xrplevm.org](https://explorer.testnet.xrplevm.org) |
